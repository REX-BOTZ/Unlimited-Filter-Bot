    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                   InlineKeyboardButton("🗣️𝙶𝚛𝚘𝚞𝚙", url="https://t.me/REX_BOT_SUPPORT"),
                   InlineKeyboardButton("🤖Bot List", url="https://t.me/REX_BOTZ/33"),
                   InlineKeyboardButton("👨‍💻Dev", url="https://t.me/benwolf24")
                ],
                [
                   InlineKeyboardButton("🔻 Group Manager 🔻", url="https://t.me/GroupManagerRexBot")
                ]
            ]
        ),
            ...
            [
                [
                    InlineKeyboardButton(
                        "⛓️ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 ⛓️", url="https://github.com/REX-BOTZ/Unlimited-Filter-Bot")
                ],
                [
